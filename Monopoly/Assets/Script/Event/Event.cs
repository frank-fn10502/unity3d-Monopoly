...
public class Event
{
    ...
    {
        //外交
        apes.AddEvent(new Diplomatic_Iindex_Rises("猩猩放棄鬥爭", true, 4, "由於猩猩死傷慘重,所以放棄鬥爭，使猩猩外交指數上升","EventImage/AllEvent"));//0
        //和平
        ...
        //領導
        apes.AddEvent(new Virus_Increase("帶著猿流感的猩猩失控爆走", false, 5, "帶著猿流感的猩猩失控爆走，使得病毒擴散加快，人類死亡3%", "EventImage/AllEvent"));//3
    ...
    private void Add_Word_Event()
    {
        ...
        word.AddEvent(new Increased_Antibody("醫院科技技術進步", true, 6, "由於醫院科技技術進步，使得人類對抗病毒抗體增加，人類解藥研發程度上升5%", "EventImage/AllEvent"));
        ...
        word.AddEvent(new Lack_Of_Energy("城市人口增加", false, 6, "城市人口增加，使得資源大量減少", "EventImage/AllEvent"));
