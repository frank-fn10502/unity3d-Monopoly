...
public class Event
{
    ...
    private void Add_Apes_Event()
    {
        ...
        apes.AddEvent(new Military_Increase("猩猩俘虜人類士兵", true, 2, "俘虜人類士兵，軍人增加100", "EventImage/AllEvent", 100));
    ...
    {
        //外交
        forest.AddEvent(new Commicave_With_Apes("和猩猩談判成功", true, 4, "由於和猩猩談判成功，使猩猩和玩家外交指數上升", "EventImage/Diplomat"));
        forest.AddEvent(new Diplomatic_Decrease("人類和猩猩起衝突", false, 5, "人類和猩猩起衝突，外交減少10", "EventImage/Apse_attack", 10));
        //和平
        forest.AddEvent(new Military_Decrease("軍隊內鬥", false, 1, "軍隊內鬥，軍隊內互相打鬥，造成傷亡，軍隊減少50人", "EventImage/Person_attacked", 50));
        //領導
    ...
    private void Add_Personal_Event()
    {
        ...
        personal.AddEvent(new Military_Decrease("發生叛亂", false, 5, "發生叛亂，軍官帶兵反抗統帥，使軍人死亡100", "EventImage/AllEvent", 100));
        //領導
        ...
        personal.AddEvent(new Military_Decrease("為防止軍隊病毒災情擴散", false, 2, "為防止軍隊病毒災情擴散，將處決軍隊受感染人數，軍隊人數減少5%", "EventImage/Execution", 5));
