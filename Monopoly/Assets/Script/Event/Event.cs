...
public class Event
{
    ...
    private void Add_Apes_Event()
    {
        ...
        apes.AddEvent(new Apes_Time_Out("猩猩被人類俘虜", false, 5, "由於猩猩被人類抓走成為俘虜，猩猩暫停一回合", "EventImage/Time_Out"));
        //和平
    ...
    private void Add_Forest_Event()
    {
        ...
        forest.AddEvent(new Military_Decrease("遭受猩猩偷襲",false,5, "闖入森林，遭受群居猩猩偷襲，軍隊減少20%", "EventImage/Apse_attack", 20));
